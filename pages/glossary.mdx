...
## vFUX
Measure of one’s value in a workstream, this is determined by the other members of your workstream in the evaluation stage. At this stage, each contributor is assigned 100vFUXFux and distributes among the team to signal the value created by each.
...
## Coordinator
The originator of the workstream in the FUXFux pProtocol. This should be a manager or admin type, that will be with the workstream until completion
