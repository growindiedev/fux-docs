...
Integration with other DAO tools; Coordinape, DeWork, HATS and Collabland all come to mind. 

## How are you building FUX vs other attempts at on-chain workstream 'orchestration flow'?

A quick comparison can be made with Coordinape, which is not fully on-chain We build FUX as a protocol, so others could connect to our Coordination LEGO and use it to augment reputation, 
...
## Where is the most exciting experimentation in this happening currently? Which projects? What inspires you here?
      ...
      - HATS: distribution of rights and roles
